...
export default function ChangeStagedSection(props: any) {
        ...
        <section className="min-h-1/3 space-y-2 p-3">
            ...
            {changes.map((c: any, i: number) => {
                ...
                return (
                    <li
                        key={i}
                        className={`flex items-center gap-2 text-sm cursor-pointer rounded p-2 ${
                            isActive ? "bg-blue-50 dark:bg-blue-900/40" : "hover:bg-muted"
                        }`}
